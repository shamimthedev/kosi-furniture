            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <Link to="/" className="inline-block mb-6">
                  <img src={Logo} alt="Kosi - Premium Furniture" className="h-10 w-auto" />
                </Link>
...
>
  <span className="w-3 h-3 border-l-2 border-t-2 border-white transform rotate-45"></span>
</button>
